import { ArrowLeft, Check, Clock3, Flame, ShieldCheck, Sparkles, Wrench, Zap } from "lucide-react";
        ...
        <section id="top" className="mx-auto grid max-w-7xl items-center gap-12 px-5 pb-20 pt-10 lg:grid-cols-[1.05fr_.95fr] lg:px-8 lg:pb-28 lg:pt-16">
          <div className="animate-fade-up">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <a href={WHATSAPP_URL} target="_blank" rel="noreferrer" className="gold-button inline-flex items-center justify-center gap-3 rounded-2xl px-7 py-4 text-base font-black">حجز فوري عبر واتساب <ArrowLeft size={19} /></a>
