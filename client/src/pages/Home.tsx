...
export default function Home() {
  ...
  const handleBooking = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    trackConversion("booking_submit"); setSubmitted(true); window.open(`https://wa.me/966509677008?text=${message}`, "_blank", "noopener,noreferrer");
  };
  ...
  return (
    <main dir="rtl" className="min-h-screen overflow-hidden bg-[#07111f] text-[#f7f2e8]">
      ...
      <div className="relative z-10">
        ...
        <a onClick={whatsappClick} href={WHATSAPP_URL} target="_blank" rel="noreferrer" className="whatsapp-float" aria-label="الحجز عبر واتساب">واتساب</a>
      </div>
    </main>
  );
}
